            ...
            <div className="container mx-auto pt-16 pb-16 md:pb-0 px-4 relative">
                <article className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-6">
                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-14" data-aos="fade-down">
                        ...
                        <a 
                            ...
                            target="_blank" 
                            className="bg-green-500 w-fit px-5 py-2 rounded-md font-semibold flex items-center justify-center gap-2
