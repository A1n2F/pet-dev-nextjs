            ...
            <div className="container mx-auto px-4">
                <div>
                    ...
                    <div className="relative">
                                    ...
                                    <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                                        <article className="bg-[#1E293B] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                            <div className="flex-1 flex items-start justify-between">
                                                <div className="flex gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-gray-400 text-sm select-none text-start">{item.description}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                                                ...
                                                <a href={`https://wa.me/556799998800?text=Olá vim pelo site e gostaria de mais informações sobre ${item.title}`} 
                                                target="_blank" 
                        ...
                        <button 
                            onClick={scrollPrev} 
                            className="bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 cursor-pointer absolute
                            left-3 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 hover:scale-120 transition-all hover:bg-gray-100">
                        ...
                        <button 
                            onClick={scrollNext} 
                            className="bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 cursor-pointer absolute
                            -right-6 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 hover:scale-120 transition-all hover:bg-gray-100">
